...
const UTIL = preload("res://addons/betterFileSystemDock/util.gd")
...
func _enter_tree() -> void:
	...
	var error = settings.load("user://betterFileSystemDocksettings.cfg")
	if error == ERR_DOES_NOT_EXIST:
		settings.save("user://betterFileSystemDocksettings.cfg")
